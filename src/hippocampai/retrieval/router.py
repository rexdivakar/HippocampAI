...
class QueryRouter:
    ...
    PREF_KEYWORDS = {
        "prefer", "like", "love", "hate", "dislike", "want", "need", "goal",
        "wish", "hope", "usually", "always", "never", "habit", "routine"
    }

    FACT_KEYWORDS = {
        "live", "work", "born", "studied", "graduated", "married", "located",
        "happened", "event", "visited", "traveled", "bought", "sold"
    }

    def route(
        self, query: str
    ) -> Literal["prefs", "facts", "both"]:
        """
