...
class PredictiveAnalyticsEngine:
    ...
    def _forecast_importance(
        ...
        return MemoryForecast(
            ...
            horizon=horizon,
            forecast_date=forecast_date,
            predicted_value=avg_importance,
            confidence_interval=(avg_importance - std_importance, avg_importance + std_importance),
            confidence=0.7,
    ...
    def _forecast_engagement(
        ...
        return MemoryForecast(
            ...
            horizon=horizon,
            forecast_date=forecast_date,
            predicted_value=avg_engagement,
            confidence_interval=(
                max(0, avg_engagement - std_engagement),
                avg_engagement + std_engagement,
            ),
            confidence=0.6,
